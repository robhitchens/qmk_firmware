...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, LOWER,                   TAPSPACE,  KC_LGUI, SHIFTL,           RAISE,  KC_RALT,  KC_RALT, KC_RGUI, KC_RCTL
    ),
    ...
    [_GAMEMODE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, LOWER,                     KC_SPC,  KC_SPC,  SHIFTL,           RAISE,  KC_RALT,  KC_RALT, KC_RGUI, KC_RCTL
    ),
    [_SPACEFN] = LAYOUT(
