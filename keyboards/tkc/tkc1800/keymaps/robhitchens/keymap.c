...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMEMODE] = LAYOUT(
    ...
    KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, XXXXXXX, KC_ENT,           KC_P4,   KC_P5,   KC_P6,   KC_PPLS, \
    KC_LSFT,  XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,      KC_UP,       KC_P1,   KC_P2,   KC_P3,   XXXXXXX, \
    KC_LALT,  LOWER,   SPECL,                   KC_SPC,                               XXXXXXX, RAISE, GUISPACE,      KC_LEFT, KC_DOWN, KC_RGHT,      _______, _______, _______  \
  ),
  [_SPECL] = LAYOUT(
    ...
    _______,  KC_MS_WH_DOWN, _______,  KC_MS_WH_UP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,  _______, _______, _______, \
