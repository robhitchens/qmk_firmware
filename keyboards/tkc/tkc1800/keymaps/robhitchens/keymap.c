...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMEMODE] = LAYOUT(
    ...
    KC_LCTRL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, XXXXXXX, KC_ENT,           KC_P4,   KC_P5,   KC_P6,   KC_PPLS, \
    KC_LSFT,  XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,      KC_UP,       KC_P1,   KC_P2,   KC_P3,   XXXXXXX, \
    KC_LGUI,  KC_LALT,   LOWER,                   KC_SPC,                               XXXXXXX, RAISE, GUISPACE,      KC_LEFT, KC_DOWN, KC_RGHT,      _______, _______, _______  \
  ),
  [_SPACEFN] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                    _______,  _______, _______, _______, \
                                                                                                                                            _______,  _______, _______, _______, \
    KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PIPE, KC_TILD, _______,  _______, _______, _______, \
    ...
    _______,  XXXXXXX, KC_GRV,  KC_MINS, KC_EQL,  KC_BSLS, KC_PIPE, KC_LBRC, KC_RBRC, XXXXXXX, KC_COLN, KC_DQUO, XXXXXXX, _______,          _______,  _______, _______, _______, \
  ...
  [_LOWER] = LAYOUT(
    ...
    _______,  XXXXXXX, KC_MS_WH_LEFT,  KC_MS_BTN3, KC_MS_WH_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______,         KC_UP,    _______,  _______, _______, XXXXXXX, \
    _______,  _______, _______,                   _______,                               XXXXXXX, _______, _______,      KC_LEFT, KC_DOWN, KC_RGHT,      _______, _______, _______  \
  ),
  [_RAISE] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                    _______,  _______, _______, _______, \
  ...
  [_ADJUST] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                    _______,  _______, _______, _______, \
                                                                                                                                            _______,  _______, _______, _______, \
    _______,  BASE,  GAMEMODE,  _______,  _______,   _______,  _______,  _______,  _______, _______,  _______, _______,  _______,  _______, XXXXXXX, _______,  _______, _______, _______, \
    _______,  RESET, DEBUG,  RGB_TOG,   RGB_MOD,    RGB_HUI,    RGB_HUD,    RGB_SAI,  RGB_SAD, RGB_VAI,  RGB_VAD, _______, _______, _______,         _______,  _______,  _______, _______, \
