...
[_QWERTY] = LAYOUT_ortho_5x14(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_HOME, KC_END,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
  ...
  KC_LALT, KC_LGUI, KC_LALT, FUNCK, LOWER,  TAPSPACE,  TAPSPACE,  KC_RSFT,  KC_RSFT, RAISE, KC_PGDN, KC_PGUP,   KC_RGUI, KC_RALT  \
),
[_GAMEMODE] = LAYOUT_ortho_5x14(
  ...
  KC_LALT, GUISPACE, KC_LALT, FUNCK, LOWER,  KC_SPC,  KC_SPC,  KC_RSFT,  KC_RSFT,  RAISE, KC_PGDN, KC_PGUP, GUISPACE, KC_RALT  \
),
[_SPACEFN] = LAYOUT_ortho_5x14(
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,  KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10, KC_GRV, \
  KC_TAB,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
