...
[_QWERTY] = LAYOUT_ortho_5x14(
  ...
  KC_ESC, KC_LGUI, KC_LALT, FUNCK, LOWER,  TAPSPACE,  TAPSPACE,  SHIFTSPACE,  SHIFTSPACE,  RAISE, KC_PGDN, KC_PGUP,   KC_RGUI, KC_RCTL  \
),
[_GAMEMODE] = LAYOUT_ortho_5x14(
  ...
  KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT, \
  KC_ESC, GUISPACE, KC_LALT, FUNCK, LOWER,  KC_SPC,  KC_SPC,  SHIFTSPACE,  SHIFTSPACE,  RAISE, KC_PGDN, KC_PGUP, GUISPACE, KC_RCTL  \
),
