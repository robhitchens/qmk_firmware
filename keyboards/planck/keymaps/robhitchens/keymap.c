...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, FUNCK, LOWER,   KC_SPC,  KC_APP,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid( \
  KC_GESC ,XXXXXXX,  KC_UP,XXXXXXX,XXXXXXX,XXXXXXX,KC_LBRACKET,KC_RBRACKET, KC_INS,KC_HOME,KC_PGUP, KC_PSCR,  \
