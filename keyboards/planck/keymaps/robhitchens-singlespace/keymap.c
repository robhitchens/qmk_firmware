...
[_GAMEMODE] = LAYOUT_planck_grid(
    ...
    KC_LCTL,     KC_A,    KC_S,  KC_D,  KC_F,     KC_G,     KC_H,  KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,
    KC_LSFT,     KC_Z,    KC_X,  KC_C,  KC_V,     KC_B,     KC_N,  KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENT,
     KC_ESC, GUISPACE, FUNCK, SPECL, LOWER,   KC_SPC,   KC_SPC, RAISE, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT),
...
[_FUNCK] = LAYOUT_planck_grid(
    ...
    KC_SLSH,     KC_0,  KC_DOT, _______,  _______, _______, _______, _______, _______, _______, _______, _______
),
